...
class Migration(migrations.Migration):
    replaces = [
        ...
        ("users", "0022_alter_user_last_search_type"),
    ]
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name="user",
            constraint=models.CheckConstraint(
                condition=models.Q(("tv_layout__in", ["grid", "table"])),
        ...
        migrations.AddConstraint(
            model_name="user",
            constraint=models.CheckConstraint(
                condition=models.Q(("season_layout__in", ["grid", "table"])),
        ...
        migrations.AddConstraint(
            model_name="user",
            constraint=models.CheckConstraint(
                condition=models.Q(("movie_layout__in", ["grid", "table"])),
        ...
        migrations.AddConstraint(
            model_name="user",
            constraint=models.CheckConstraint(
                condition=models.Q(("anime_layout__in", ["grid", "table"])),
        ...
        migrations.AddConstraint(
            model_name="user",
            constraint=models.CheckConstraint(
                condition=models.Q(("manga_layout__in", ["grid", "table"])),
        ...
        migrations.AddConstraint(
            model_name="user",
            constraint=models.CheckConstraint(
                condition=models.Q(("game_layout__in", ["grid", "table"])),
        ...
        migrations.AddConstraint(
            model_name="user",
            constraint=models.CheckConstraint(
                condition=models.Q(("book_layout__in", ["grid", "table"])),
        ...
        migrations.AddConstraint(
            model_name="user",
            constraint=models.CheckConstraint(
                condition=models.Q(("calendar_layout__in", ["grid", "list"])),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                condition=models.Q(
                    (
                        "lists_sort__in",
                        ["last_item_added", "name", "items_count", "creation_order"],
                    )
                ),
