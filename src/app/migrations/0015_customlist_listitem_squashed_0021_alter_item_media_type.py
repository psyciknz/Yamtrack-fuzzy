...
class Migration(migrations.Migration):
    ...
    dependencies = [
        (
            "app",
            "0001_squashed_0014_historicalanime_historicalepisode_historicalgame_and_more",
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "custom_list",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="app.customlist"
                    ),
                ),
                (
                    "item",
